...
def start():
    ...
    win.fill((00,00,00))
    text=font.render("Tic Tac Toe",True,(200,200,200),(00,0,0))
    ...
    win.fill((0,0,0))
    pygame.draw.line(win,(200,200,200),(3,0),(3,600),6)
    # vertical lines
    pygame.draw.line(win,(200,200,200),(396,0),(396,600),6)
    pygame.draw.line(win,(200,200,200),(width/3,0),(width/3,height),6)
    pygame.draw.line(win,(200,200,200),((width/3)*2,0),((width/3)*2,height),6)
    #horizontal lines
    pygame.draw.line(win,(200,200,200),(0,(height/3)*0.01),(width,(height/3)*0.01),6)
    pygame.draw.line(win,(200,200,200),(0,height/3),(width,height/3),6)
    pygame.draw.line(win,(200,200,200),(0,(height/3)*2),(width,(height/3)*2),6)
    pygame.draw.line(win,(200,200,200),(0,(height/3)*3),(width,(height/3)*3),6)
    pygame.draw.line(win,(200,200,200),(0,(height/3)*3.72),(width,(height/3)*3.72),6)
...
def draw_figure(row,col):
     ...
     if(box[row,col] == 0):
        ...
        if(XO=='o'):
            ...
            pygame.draw.circle(win, (0,0,255), (posy, posx ), 40,10)
            ...
            pygame.draw.line (win,(255,0,0), (posy - 30, posx - 30),
    ...
    #Show Player Message turns 
     ...
     text = font.render(message, True,(0,250,0),((250,250,250)))
     textRect = text.get_rect()
...
def check_Winner():
    ...
    for row in range (0,3):
        if ((box [row][0] == box[row][1] == box[row][2]) and(box [row][0] != 0)):
            # this row won
            Winner = box[row][0]
            pygame.draw.line(win, (87,1,81), (0, (row + 1)*height/3 -height/6),\
                              (width, (row + 1)*height/3 - height/6 ), 10)
    ...
    for col in range (0, 3):
        if (box[0][col] == box[1][col] == box[2][col]) and (box[0][col] != 0):
            ...
            Winner = box[0][col]
            #draw winning line
            pygame.draw.line (win, (87,1,81),((col + 1)* width/3 - width/6, 0),\
    ...
    if (box[0][0] == box[1][1] == box[2][2]) and (box[0][0] != 0):
        ...
        Winner = box[0][0]
        pygame.draw.line (win, (87,1,81), (50, 50), (360, 360), 10)
        show_winning_message(Winner)
    ...
    if (box[0][2] == box[1][1] == box[2][0]) and (box[0][2] != 0):
        ...
        Winner = box[0][2]
        pygame.draw.line (win, (87,1,81), (350, 50), (50, 350), 10)
        show_winning_message(Winner)
