...
button1=Button(window,width=10,text="Load Pickle",bg='#a2bbbd',command=loadFile)
button1.grid(row=2,column=4)

button8=Button(window,width=10,text="Filter",bg='#a2bbbd',command=filterList)
button8.grid(row=2,column=5)

#second section 
#row - 0
button2=Button(window,width=10,text="Add",bg='#a2bbbd',command=addList)
button2.grid(row=0,column=4)

#row - 1
button4=Button(window,width=10,text="Delete",bg='#a2bbbd',command=delete)
button4.grid(row=1,column=4)

button5=Button(window,width=10,text="Sort Mileage",bg='#a2bbbd',command=sortMileage)
button5.grid(row=1,column=5)

#row - 2
# button6=Button(window,width=10,text="Filter",bg='#a2bbbd')
# button6.grid(row=2,column=4)

button7=Button(window,width=10,text="Create Pickle",bg='#a2bbbd',command=createPickle)
